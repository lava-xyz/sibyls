...
fn main() {
    ...
    match args.command {
        ...
        Commands::Inspect { key } => match inspect_key(&secp, &key) {
...
mod tests {
    ...
    fn test_inspect_key_from_str() {
        ...
        let expected_public_key_hex =
            "0244990384b935f24a9c0babd4642113678c3dde5dc7904589497bc435f90bfe1f";
    ...
    fn test_generate_keypair_file_overwrite() {
        ...
        let (secret_key_hex1, public_key_hex1) =
            generate_keypair(&secp, Some(&path), false).unwrap();
        ...
        let (secret_key_hex2, public_key_hex2) =
            generate_keypair(&secp, Some(&path), true).unwrap();
